...
LAST GREEN SHA: 17d8ab7 (local; the operator pushes manually — decided 2026-07-14. Agents: do not push.)
...
- [ ] Phase 3 — Boundary conformance (Docker)
  ...
  - [x] D6 sealed-pack reconstruction core: a manifest-verified accepted seal
        ...
        manifest or pack read, rejecting a same-path replacement.
