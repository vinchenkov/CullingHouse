...
func TestCompletionSealsAreTypedImmutableAndStateFenced(t *testing.T) {
	...
	mustExec(t, db, `INSERT INTO completion_seals (run_id,task_id,completion_request_id,object_format,sealed_sha,closure_digest,manifest_digest,seal_device,seal_inode,seal_owner_uid) VALUES ('run-7',7,'0011223344556677','sha1',? ,?,?,'1','2',501)`, sha, digest, manifest)
	...
	wantAbort(t, db, `INSERT INTO completion_seals (run_id,task_id,completion_request_id,object_format,sealed_sha,closure_digest,manifest_digest,seal_device,seal_inode,seal_owner_uid) VALUES ('run-8',8,'0011223344556678','sha1',x'6161',?,?, '1','2',501)`, digest, manifest)
	mustExec(t, db, `INSERT INTO completion_seals (run_id,task_id,completion_request_id,object_format,sealed_sha,closure_digest,manifest_digest,seal_device,seal_inode,seal_owner_uid) VALUES ('run-8',8,'0011223344556678','sha1',?,?,?,'1','2',501)`, sha, digest, manifest)
	wantAbort(t, db, `UPDATE completion_seals SET manifest_digest=? WHERE run_id='run-8'`, strings.Repeat("d", 64))
}
